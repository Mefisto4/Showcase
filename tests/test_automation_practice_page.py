...
class TestAutomationPracticePage:
    ...
    def test_go_to_practice_page(self):
        """Test if page opens."""
        self.tools.logger.info("Test if page opens.")
        self.page.go_to()
    ...
    def test_radiobuttons(self, radiobutton, expected_states):
        ...
        self.tools.logger.info("Test if radiobutton group set work correctly.")
    ...
    def test_dropdown_dynamic_default(self):
        ...
        self.tools.logger.info("Test if default state of dynamic dropdown is correct.")
    ...
    def test_dropdown_dynamic_select(self):
        ...
        self.tools.logger.info("Test if select by full value in dynamic dropdown works correctly.")
    ...
    def test_dropdown_dynamic_select_by_partial_value(self):
        ...
        self.tools.logger.info("Test if select by partial value in dynamic dropdown works correctly.")
    ...
    def test_checkboxes(self, checkbox, expected_states):
        ...
        self.tools.logger.info("Test if checkbox group set works correctly.")
        if checkbox != "default":
    ...
    def test_switch_window(self):
        ...
        self.tools.logger.info("Test if switching between browser windows works correctly.")
    ...
    def test_switch_tab(self):
        ...
        self.tools.logger.info("Test if switching between browser tabs works correctly.")
    ...
    def test_alert(self):
        ...
        self.tools.logger.info("Test if alert window works correctly.")
        msg = "TEXT 1"
    ...
    def test_popup(self):
        ...
        self.tools.logger.info("Test if popup window works correctly.")
        msg = "TEXT 2"
        self.page.alert_textbox.set_text(msg)
    ...
    def test_web_table_get_headers(self):
        ...
        self.tools.logger.info("Test if web table headers works correctly.")
    ...
    def test_web_table_get_body(self):
        ...
        self.tools.logger.info("Test if web table body works correctly.")
    ...
    def test_web_table_get_table(self):
        ...
        self.tools.logger.info("Test if web table as a whole works correctly.")
    ...
    def test_web_table_fixed_get_headers(self):
        ...
        self.tools.logger.info("Test if fixed headers web table headers works correctly.")
    ...
    def test_web_table_fixed_get_body(self):
        ...
        self.tools.logger.info("Test if fixed headers web table body works correctly.")
    ...
    def test_web_table_fixed_get_table(self):
        ...
        self.tools.logger.info("Test if fixed headers web table as a whole works correctly.")
    ...
    def test_web_table_label(self):
        """Test label."""
        self.tools.logger.info("Test if label works correctly.")
    ...
    def test_element_displayed_default_state(self):
        ...
        self.tools.logger.info("Test if default state of hide/show textbox works correctly.")
        assert self.page.hide_show_textbox.is_displayed()

    def test_element_displayed_hide(self):
        """Test textbox hide option."""
        self.tools.logger.info("Test if textbox hide option works correctly.")
    ...
    def test_element_displayed_show(self):
        ...
        self.tools.logger.info("Test if textbox show option works correctly.")
        self.page.show_button.click()
        assert self.page.hide_show_textbox.is_displayed()

    def test_mouse_hover_default_state(self):
        """Test default state of display-element-on-hover object."""
        self.tools.logger.info("Test if default state of display-element-on-hover object works correctly.")
    ...
    def test_mouse_hover_mouse_move_action(self):
        ...
        self.tools.logger.info("Test if 'on hover' action works correctly.")
    ...
    def test_mouse_hover_top_option(self):
        ...
        self.tools.logger.info("Test if 'top' option works correctly.")
    ...
    def test_mouse_hover_reload_option(self):
        ...
        self.tools.logger.info("Test if 'reload' option works correctly.")
    ...
    def test_iframe_outer_scope_before(self):
        ...
        self.tools.logger.info("Test if iframe's webpage is not accessible outside iframe.")
    ...
    def test_iframe_context_manager(self):
        ...
        self.tools.logger.info("Test if iframe's webpage is accessible inside iframe.")
    ...
    def test_iframe_outer_scope_after(self):
        ...
        self.tools.logger.info("Test if iframe's webpage is still not accessible outside iframe.")
        iframe_page = RahulShettyAcademyPage(self.driver)
        with pytest.raises(NoSuchElementException):
            assert not iframe_page.courses_link.is_present()
